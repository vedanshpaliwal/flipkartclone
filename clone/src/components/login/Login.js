                    ...
                    <Box style={{ display: 'flex' }}>
                        ...
                        </Box>
                        {
                            account === initialvalue.login ? <Box className={classes.login} >
                                ...
                                <TextField name='password'   onChange={(e)=>{onvaluechange(e)}}  label='Enter Password' />
                                {
                                ...
                                <Typography onClick={() => { toggleclick() }} className={classes.createtext}  > New to Flipkart Create an account </Typography>
